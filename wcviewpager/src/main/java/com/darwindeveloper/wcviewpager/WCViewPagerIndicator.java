...
public class WCViewPagerIndicator extends LinearLayout {
    ...
    public WCViewPagerIndicator(Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            indicatorsColor = a.getColor(R.styleable.WCViewPagerIndicator_indicatorsColor, Color.GRAY);
            indicatorSelectedColor = a.getColor(R.styleable.WCViewPagerIndicator_indicatorSelectedColor, Color.BLUE);
            numbersColor = a.getColor(R.styleable.WCViewPagerIndicator_numbersColor, Color.GRAY);
            numberSeletedColor = a.getColor(R.styleable.WCViewPagerIndicator_numberSelectedColor, Color.BLUE);
