...
public class WCExclusivePagerIndicator extends LinearLayout {
    ...
    public WCExclusivePagerIndicator(Context context) {
        super(context);
        this.context = context;
    }

    public WCExclusivePagerIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        ...
        inflater.inflate(R.layout.viewpager_exclusive, this, true);
    ...
    private void init() {
        viewPager = (WrapContentViewPager) findViewById(R.id.wrap_content_viewpager_exclusive);
        recyclerViewIndicators = (RecyclerView) findViewById(R.id.recyclerview_exclusive);
